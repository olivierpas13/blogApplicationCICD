...
export const {
  createBlog, setBlogs, voteBlog, eliminateBlog, commentOneBlog,
} = blogSlice.actions;
...
export const createNewBlog = (content) => async (dispatch) => {
  // try {
...
export const voteForBlog = (id) => async (dispatch) => {
  await blogService.updateBlog(id);
  dispatch(voteBlog(id));
};

export const deleteOneBlog = (id) => async (dispatch) => {
  await blogService.deleteBlog(id);
  dispatch(eliminateBlog(id));
};

export const commentBlog = (content, id) => async (dispatch) => {
